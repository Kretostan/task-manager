...
const ModalButtons = ({ ref, closeModal, isEdit }: ModalButtonsProps) => {
  return <div className="flex flex-col md:flex-row-reverse gap-4 mt-8 px-8 pt-8 w-full border-t-1 border-primary/20">
    <PrimaryButton path="#" className="md:px-7 py-2 md:py-3 md:text-lg font-semibold">{isEdit ? "Update" : "Create"} Task</PrimaryButton>
